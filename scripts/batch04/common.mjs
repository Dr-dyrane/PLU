...
export const productHeadGroups = [
  ...
  ["berry", "berries", "blueberry", "blueberries", "blackberry", "blackberries", "raspberry", "raspberries", "strawberry", "strawberries"],
  ["olive", "olives"], ["pistachio", "pistachios"],
...
export const mediaOverridesByCatalogId = {
  ...
  "cucumbers-dill": "PicklingCucumbers.jpg",
